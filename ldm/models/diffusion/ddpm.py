...
class DDPM(pl.LightningModule):
    ...
    def __init__(self,
        ...
        self.image_size = image_size  # try conv? # 32
        self.channels = channels
        self.use_positional_encodings = use_positional_encodings # False
        self.model = DiffusionWrapper(unet_config, conditioning_key) # conditioning_key: hybrid
...
class LatentDiffusion(DDPM):
    ...
    def __init__(self,
        ...
        if conditioning_key is None: # hybrid
        ...
        self.instantiate_first_stage(first_stage_config) # AutoencoderKL for first stage
        self.instantiate_cond_stage(cond_stage_config) # ldm.modules.encoders.modules.FrozenCLIPImageEmbedder
    ...
    def instantiate_cond_stage(self, config):
        if not self.cond_stage_trainable: # self.cond_stage_trainable = False
